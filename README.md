...
### 📈 [Linear Regression: Three Case Studies with OLS](link-here)
...
### 🌳 [Ensemble Learning for Binary Classification](link-here)
...
### 📊 [Time Series Analysis & Forecasting](link-here)
...
## Skills
Statistical modeling · hypothesis testing · time series forecasting · ensemble methods · R · Python (pandas, matplotlib, seaborn, plotly) · data visualization
